...
extension UIImageView{
    func loadImageFrom(url: String, dominantColor:String = ""){
        ...
        let imageURL = url.removingPercentEncoding
...
extension UITextField{
    ...
    func setPlaceHolderColor(data:String){
        ...
        let range = (strNumber).range(of: ASTERISK.lowercased())
...
extension UIButton{
    func applyCorner(){
        ...
        self.backgroundColor = UIColor().HexToColor(hexString: BUTTON_COLOR)
    }
...
extension UILabel{
    ...
    func applyDarkGrey(){
        self.textColor = UIColor().HexToColor(hexString: DARKGREY)
    }
