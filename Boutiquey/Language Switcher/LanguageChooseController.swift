...
var languageCode:String = "en"
    ...
    override func viewDidLoad() {
        ...
        englishButton.setTitleColor(UIColor().HexToColor(hexString: BUTTON_COLOR), for: .normal)
        englishButton.layer.borderWidth = 1
        englishButton.layer.borderColor = UIColor().HexToColor(hexString: BUTTON_COLOR).cgColor
        ...
        selectButton.backgroundColor = UIColor().HexToColor(hexString: BUTTON_COLOR)
    ...
    @IBAction func arabicClick(_ sender: UIButton) {
        ...
        arabicButton.setTitleColor(UIColor().HexToColor(hexString: BUTTON_COLOR), for: .normal)
        arabicButton.layer.borderColor = UIColor().HexToColor(hexString: BUTTON_COLOR).cgColor
        languageCode = "ar"
